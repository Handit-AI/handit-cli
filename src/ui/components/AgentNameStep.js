 ...
 */
function AgentNameStep(React, Box, Text, { agentName, onInput, currentValue, isCompleted = false }) {
  return React.createElement(Box, { key: 'step1', flexDirection: 'column', marginTop: 2 }, [
    ...
    React.createElement(Text, { key: 'step-description', color: 'white', marginTop: 1 }, 'Give your agent a descriptive name.'),
    ...
    isCompleted ? React.createElement(Box, { key: 'step-value', marginTop: 1 }, [
      React.createElement(Text, { key: 'final-value', color: '#71f2af' }, agentName)
