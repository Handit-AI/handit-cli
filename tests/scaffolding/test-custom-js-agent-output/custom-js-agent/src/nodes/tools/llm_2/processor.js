/**
 * Llm_2 tool node processor
 */

import { BaseToolNode } from '../../../base.js';

export class Llm_2ToolNode extends BaseToolNode {
  ...
  async process(inputData) {
    try {
      ...
      const result = await this._execute_llm_2_tool_logic(inputData);
  ...
  async _execute_llm_2_tool_logic(inputData) {
